...
var questaoFolhas = {nome: "questaoFolhas", titulo: "inferno verde", botao1: "Tomar rumo à direita, para explorar mais o terreno", botao2: "Tomar rumo à esquerda, para explorar mais o terreno", texto: "Você tenta arrancar algumas folhas, mas acaba colocando suas mãos em espinhos. Suas mãos ficam em total sangue. Você grita de dor e raiva. Você não aguenta mais o ambiente em que você está, cheio de perigos e surpresas desagradáveis. Mas, você quer sobreviver. Para isso, você precisa achar mantimentos logo. Você irá:",}

conjuntoFolhas = [questaoFolhas]
folhasUsados = []


var questaoAranha = {nome: "questaoAranha", titulo: "agonia de pequenas pernas", botao1: "Seguir em frente, em direção às colinas", botao2: "Sentar um pouco, você precisa descansar", texto: "Uma aranha rapidamente pulou em sua mão, esfregando suas pernas peludas em sua pele. Em desespero, você sacode sua mão, tentando derrubar ela, na qual surte efeito. Por um momento. Ela ligeiramente sobe em uma árvore e pula diretamente em seu rosto. Assustado e agoniado, você esfrega suas mãos desesperamente em seu rosto, e a aranha cai novamente no chão, dessa vez indo para longe. Essa pequena criatura aparentou ter gostado de você. Mas agora, você precisará ignorar potenciais “amigos” e continuar seu caminho. Voce irá:",}
